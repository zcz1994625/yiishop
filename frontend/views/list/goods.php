...
<div class="main w1210 mt10 bc">
    ...
    <div class="breadcrumb">
        <h2>当前位置：<a href="">首页</a> > <a href=""><?=$category->name?></a>  > <?=$goods->name?></h2>
    </div>
    <!-- 面包屑导航 end -->
    ...
    <div class="goods_left fl">
        ...
        <div class="related_cat leftbar mt10">
            ...
            <div class="leftbar_wrap">
                <ul>
                    <?php
                        $childs = \backend\models\GoodsCategory::find()->where(['parent_id'=>$category->id])->all();
                    ?>
                ...
                <div class="smallpic">
                    ...
                    <div class="smallpic_wrap">
                        <ul>
                            ...
                            <li class="<?=$k==0?'cur':''?>">
                                <a class="<?=$k==0?'zoomThumbActive':''?>" href="javascript:void(0);" rel="{gallery: 'gal1', smallimage: '<?=Yii::getAlias('@web')?>/images/preview_m1.jpg',largeimage: '<?=Yii::getAlias('@web')?>/images/preview_l1.jpg'}"><img src="<?=$gallery->path?>"></a>
                            </li>
                            <?php endforeach;?>
                        </ul>
                    </div>
