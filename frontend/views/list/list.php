<div class="list w1210 bc mt10">
    ...
    <div class="breadcrumb">
        <h2>当前位置：<a href="<?=\yii\helpers\Url::to(['index/index'])?>">首页</a> > <a href=""><?=$category->name?></a></h2>
    </div>
    <!-- 面包屑导航 end -->
    ...
    <div class="list_left fl mt10">
        ...
        <div class="catlist">
            ...
            <div class="catlist_wrap">
                <?php
                $twos = \backend\models\GoodsCategory::find()->where(['parent_id'=>$category->id])->all();
                ?>
                <?php foreach($twos as $k=>$two):?>
                    <div class="child">
                        <h3 class="<?=$k==0?'on':''?>"><b></b><?=$two->name?></h3>
                        <ul class="<?=$k==0?'':'none'?>">
                            <?php
            ...
            <div class="filter_wrap">
                <dl>
                    ...
                    <?php foreach($brands as $k=>$brand):?>
                        <dd class="<?=$k==0?'cur':''?>"><a href=""><?=$brand->name?></a></dd>
                    <?php endforeach;?>
                </dl>
        ...
        <div class="goodslist mt10">
            <ul>
                <?php foreach($goods as $good):?>
                    <li>
                        <dl>
                            <dt><a href="<?=\yii\helpers\Url::to(['list/goods','goods_id'=>$good->id,'category_id'=>$good->goods_category_id])?>"><img src="<?=$good->logo?>" alt="" /></a></dt>
                            <dd><a href="<?=\yii\helpers\Url::to(['list/goods','goods_id'=>$good->id,'category_id'=>$good->goods_category_id])?>"><?=$good->name?></a></dd>
