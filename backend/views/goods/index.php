...
echo \yii\bootstrap\Html::a('回收站',['goods/dellist'],['class'=>'btn btn-warning']);
?>
...
<table class="table table-hover table-bordered">
    ...
    <?php foreach($goods as $good):?>
        <tr>
            ...
            <td>
                <?=\yii\bootstrap\Html::a('删除',['goods/del','id'=>$good->id],['class'=>'btn btn-danger'])?>
                <?=\yii\bootstrap\Html::a('编辑',['goods/edit','id'=>$good->id],['class'=>'btn btn-info'])?>
                <?=\yii\bootstrap\Html::a('相册',['goods/gallery','id'=>$good->id],['class'=>'btn btn-primary'])?>
            </td>
        </tr>
    <?php endforeach;?>
</table>
